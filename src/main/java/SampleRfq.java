...
public class SampleRfq extends SimpleWrapper {
    ...
    public SampleRfq(int clientId, int ContractId, int mode) {
        m_clientId = clientId;
...
//        client().placeOrder(m_contractId, m_contract, new Contract(m_clientId, m_contractId, 1));
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            SampleRfq ut = new SampleRfq(/* clientId */ 2, ContractId, mode);
            ut.testOrder();
        } catch (Exception e) {
            e.printStackTrace();
        }
